...
Small utility I cobbled together using sample source code from various projects, designed to suit my personal preferences and use case. This is NOT production software for the general public, but may be useful to others. Everything you see in the example config file is more or less what you can use. The redundant pieces like the "keyboard, mouse, or both?" setting and feedback sounds from SDL2 have been removed as I never used them, and the new control flow should work better anyway and allow for better customization of which events to trigger PTT.
...
- [x] Keyboard binding support for chords
